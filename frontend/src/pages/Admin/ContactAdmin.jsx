...
const ContactAdmin = () => {
  ...
  const getContact = async () => {
    ...
    try{
      const res = await axios.get(`${baseURL}/api/admin/contact/${id}`,{
        headers:{
          Authorization: token
        }
      });
  ...
  return (
    <div className=' py-10 text-center text-3xl text-white w-full'>
        <p className=' underline break-words px-10'>
          {contact.email}
        </p>
        <div className=" pt-10">
          <p className=' px-10 break-words text-[1.5rem] leading-8'>
